...
Today another rumination about programming computers. Today's thoughts expand on an earlier piece that I wrote here about <a href="/what-programming-languages-say.html
">programming languages</a>, but it is also related to how programs are <a href="/the-inscrutable-tubes.html">inscrutable tubes of complexity</a>, and who is <a href="/who-are-the-programmers.html"> good at programming computers anyway</a>.

With some trepidation I will wade into that old warhorse topic: "static" vs. "dynamic" languages. This came up a couple of months ago in the context of the evolution of the Swift language, which I have <a href="/what-programming-languages-say.html
