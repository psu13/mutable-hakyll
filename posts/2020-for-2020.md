...
As a digression ... the show spent a lot of time wondering if *pot sticker* was just a bullshit name for the fried version of jiao zi. The truth is that it's a pretty good translation of the Mandarin word for the fried dumplings which is 锅贴, or <a href="https://translate.google.com/?sl=en&tl=zh-CN&text=pot%20sticker%0A&op=translate">"guo tie"</a>: literally the stuff that sticks to the bottom of the pan ("guo" means pan, or pot and "tie" stick). The much larger mistranslation is calling jiao zi "dumplings" in the first place since in the Western usage dumplings are *not* filled with anything. All of those filled pastas and related foods get their own names (tortellini, ravioli, cannelloni, pierogi, pelmeni, kreplach, gyoza, mandu, mo-mo, samosa, etc). Only jiao zi get singled out for the bad translation to "dumplings" ... mostly because the Mandarin word is hard for non-Chinese people to say.
