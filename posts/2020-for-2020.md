...
off when you try to take it out ("tie" means to stick). The much larger mistranslation is
calling jiao zi "dumplings" in the first place since in the Western usage dumplings are
*not* filled with anything. All of those filled pastas and related foods get their own
names (tortellini, ravioli, cannelloni, pierogi, pelmeni, kreplach, gyoza, mandu, mo-mo,
samosa, etc). Only jiao zi get singled out for the bad translation to "dumplings" ...
mostly because the Mandarin word is hard for non-Chinese people to say.
