...
These functions are called "wave functions" because in the original problems that quantum
...
However, unlike the experiment with real waves, you cannot actually observe the wave fronts
